          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Загрузите Excel файл с данными сотрудников. Поддерживаемые поля: ФИО, Должность, Грейд, Отдел, Серия паспорта, Номер паспорта, Кем выдан, Дата выдачи, Адрес прописки, Номер приказа, Дата приказа, Номер акта мат. ответственности, Дата акта мат. ответственности, Наименование имущества, Инвентарный номер, Стоимость
              </p>
            </div>
